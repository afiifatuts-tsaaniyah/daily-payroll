...
class M_rp_db extends Model
{
     ...
     {
          $stQuery  = "SELECT * FROM ".$this->table." WHERE date_process BETWEEN '".$this->startDate."' AND '".$this->endDate."' AND biodata_id = '".$id."';";
          // echo $stQuery;
          // exit();
     ...
     {
          $stQuery = "SELECT a.*,b.*,c.*,d.*,e.* FROM tr_slip a, mt_salary b, tr_timesheet c, mt_biodata_01 d, mt_bank e WHERE a.biodata_id = b.biodata_id AND a.ts_id = c.ts_id AND a.biodata_id = d.biodata_id AND a.bank_id = e.bank_id AND slip_id ='".$Id."';";
          // echo $stQuery;
          // exit();
         $query = $this->db->query($stQuery)->getResultArray();
          return $query; 
