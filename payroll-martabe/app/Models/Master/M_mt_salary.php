...
class M_mt_salary extends Model
{
     ...
     public function ins()
     {
      ...
      $stQuery .=   "'".$this->db->escapeString($this->accNo)."',";
          $stQuery .=   "'".$this->db->escapeString($this->accName)."',";
     ...
     public function upd($id)
     {
      ...
      $stQuery .=   "account_no ='".$this->db->escapeString($this->accNo)."', "; 
      //     $stQuery .=   "account_name ='".$this->db->escapeString($this->accName)."', "; 
      ...
      $stQuery .=   'daily ='.$this->daily.','; 
         ...
         $stQuery .=   'status_payroll ="'.$this->db->escapeString($this->month).'",'; 
     ...
     public function getById($id)
     {
      ...
      $stQuery .= "WHERE a.biodata_id = b.biodata_id AND a.bank_id = c.bank_id AND salary_id = '".$this->db->escapeString($id)."'";
      $query  = $this->db->query($stQuery); 
