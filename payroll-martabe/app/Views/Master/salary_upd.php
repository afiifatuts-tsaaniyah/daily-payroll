          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <div class="form-group col-md-3">
                ...
                <input class="form-control" name="daily" id="daily" type="number" placeholder="Daily" value="<?php echo $mtSalary['daily'] ?>">
              </div>
                </div>
                <div class="form-group col-sm-12 col-md-3 govReg">     
                <input type="checkbox" id="cbHealthBPJS" name="cbHealthBPJS" value="<?php echo $mtSalary['bpjs_check'] ?>" <?php if ($mtSalary['bpjs_check'] == 1) {
                  echo "checked";
                } ?>>
                ...
                <input type="checkbox" id="cbJHT" name="cbJHT" value="<?php echo $mtSalary['jht_check'] ?>" <?php if ($mtSalary['jht_check'] == 1) {
                  echo "checked";
                } ?>>
                <label class="control-label" for="JHT" <?php if ($mtSalary['jht_check'] == 1) {
                  echo "checked";
                } ?>>JHT</label>&nbsp;&nbsp;&nbsp;&nbsp;

                <input type="checkbox" id="cbJP" name="cbJP" value="<?php echo $mtSalary['jp_check'] ?>"<?php if ($mtSalary['jp_check'] == 1) {
                  echo "checked";
                } ?>>
                <label class="control-label" for="JP">JP</label>&nbsp;&nbsp;&nbsp;&nbsp;

                <input type="checkbox" id="cbJKKM" name="cbJKKM" value="<?php echo $mtSalary['jkm_check'] ?>" <?php if ($mtSalary['jkm_check'] == 1) {
                  echo "checked";
                } ?>>
                ...
                <div class="form-group col-md-3"> Payroll Status </br>
                    <?php 
                      $payrollStatus = $mtSalary['status'];
                      if ($payrollStatus == 'month') {
                        echo '<input class="form-check-input" type="radio" name="payrollstatus" id="payrollstatus" value="month" checked>
                                               ...
                                               <input class="form-check-input" type="radio" name="payrollstatus" id="payrollstatus" value="daily pkwt" >
                                              <label class="form-check-label" for="flexRadioDefault3">
                                                Daily PKWT
                                              </label> ' ;
                      } else if ($payrollStatus == 'daily') {
                        echo '<input class="form-check-input" type="radio" name="payrollstatus" id="payrollstatus" value="month" >
                                              <label class="form-check-label" for="flexRadioDefault1">
                                                Monthly&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                              </label>            
                                              <input class="form-check-input" type="radio" name="payrollstatus" id="payrollstatus" value="daily" checked>
                                              <label class="form-check-label" for="flexRadioDefault2">
                                                Daily&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
                                              </label> 
                                              <input class="form-check-input" type="radio" name="payrollstatus" id="payrollstatus" value="daily pkwt" >
                      ...
                      else if ($payrollStatus == 'daily pkwt') {
                        echo '<input class="form-check-input" type="radio" name="payrollstatus" id="payrollstatus" value="month" >
                                              <label class="form-check-label" for="flexRadioDefault1">
                                                Monthly
                                              </label>            
