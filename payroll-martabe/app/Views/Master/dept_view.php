          ...
          <div class="tile">
           <div class="tile-body">
           	...
           	<div class="table-responsive">
           	  <table class="table table-hover table-bordered" id="mtDept">
      ...
      <script>
        ...
        $(document).ready(function() {
        	...
        	$.ajax({
        		/* ***Url is here */
        		url : baseUrl+'/master/Mt_dept/getAll',
        		method : "POST",
        		success : function(data)
        		{
        			...
        			/* Edit Url Controller is here */
          			/* ***Using Valid Path */
        			let updUrl = '<?php echo base_url(); ?>/Master/Mt_dept/upd_view/';
        			/* START TABLE */
        			let mtDept = $("#mtDept").DataTable({
        				"paging":   true,
        				"ordering": true,
        				"info":     true,
        				"filter":   false,
        				...
        				"columnDefs": [
        								...
        								},
        								{
        									...
        									"render": function ( data, type, row, meta ) {
        									  ...
        									  return '<a href="'+updUrl+row['dept_id']+'" class="btn btn-sm btn-warning">Edit</a> <button class="btn btn-sm btn-danger" type="button" id="delete" data-id="'+row['dept_id']+'">Delete</button>';
        									}
        								}
        				],
        				data : srcData,
          ...
          $('#mtDept').on('click','#delete', function (e) {
        ...
        function deleteRow(e){
          ...
          $.ajax({
            ...
            type : "POST",
            url: baseUrl+'/Master/Mt_dept/del',
