              ...
              <form class="form-horizontal" method="POST" action="../insData">
                <div class="form-group row">
                  ...
                  <div class="col-md-auto">
                    ...
                    <input class="form-control" name="bankId" id="bankId" type="hidden" value="<?php echo $mtBank['bank_id'] ?>">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-1">
                    <input type="checkbox" id="isLocal" name="isLocal" value="1" <?= ($mtBank['is_local']==1)? 'checked' : ''; ?> >
                  </div>
                </div>
              </form>
            </div> <!-- class="tile-body" -->
