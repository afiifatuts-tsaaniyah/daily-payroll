...
<div class="col-md-12" id="is_transaction">
  <div class="tile bg-info">
	...
	<!-- <div class="form-group col-sm-12 col-md-2 sm">
          ...
          <select class="js-example-basic-multiple" id="sm" name="sm" required="">
    				<option value="" disabled="" selected="">Pilih</option>
    				<script type="text/javascript">
              var tDay = 1;
...
<script src="<?php echo base_url()?>/assets/js/main.js"></script>
    ...
    var summaryInvoice = $('#summaryInvoice').DataTable({
        ...
        $('#viewInvoiceList').on("click", function(){
                ...
                var myUrl ='';
                if (name  == "nap") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/getPayrollListInvoice/'+yearPeriod+'/'+monthPeriod+'/'+sm;
                } else if (name  == "invoice") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/getPayrollListInvoice/'+yearPeriod+'/'+monthPeriod+'/'+sm;
                } else if (name == "timesheet") {
