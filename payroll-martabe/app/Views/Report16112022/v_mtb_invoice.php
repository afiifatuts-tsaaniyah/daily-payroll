...
<script src="<?php echo base_url()?>/assets/js/main.js"></script>
    ...
    var slipTable = $('#invoiceList').DataTable({
		...
		var sm  = $('#sm').val();
                ...
                if (name == "payment") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/exportPaymentPayrollPontilSwq/'+yearPeriod+'/'+monthPeriod+'/'+sm+'/'+dept;
                } else if (name == "invoice") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/exportinvoicePayrollPontilSwq/'+yearPeriod+'/'+sm+'/'+monthPeriod;
                } else if (name == "summary") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/exportSummaryPayrollPontilSwq/'+yearPeriod+'/'+sm+'/'+monthPeriod+'/'+dept;
                } else if (name == "form") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/exportPaymentForm/'+yearPeriod+'/'+monthPeriod+'/'+sm;
                }
		...
		var sm  = $('#sm').val();
                ...
                var myUrl ='';
                if (name  == "payment") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/getPayrolldeptList/'+yearPeriod+'/'+monthPeriod+'/'+sm+'/'+dept;
                } else if (name  == "invoice") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/getPayrollList/'+yearPeriod+'/'+monthPeriod+'/'+sm;
                } else if (name  == "summary") {
                  myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/getPayrolldeptList/'+yearPeriod+'/'+monthPeriod+'/'+sm+'/'+dept;
                } else if (name  == "form") {
                  myUrl ='<?php echo base_url() ?>/Report/Mtb_invoice/getPayrollList/'+yearPeriod+'/'+monthPeriod+'/'+sm;
                }
