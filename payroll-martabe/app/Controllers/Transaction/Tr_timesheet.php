    ...
    public function Excel($ts_id,$checkBpjs,$checkJHT,$checkJP,$checkJKKJKM,$spreadsheet, $noNewSheet)
    {
        ...
        // dd($row);
            ...
            /*echo $startDate.'</br>';*/
                ...
                $outVal = (int)$inVal + (int)$phHoursTmp;
                if ($outVal > 24) {
                    $outVal = $outVal - 24;
                }
                ...
                if ($phCodeTmp == "DS" || $phCodeTmp == "NS" || $phCodeTmp == "AS" || $phCodeTmp == "SL" || $phCodeTmp == "MD" || $phCodeTmp == "AB") {
                    $absen = 1;
                } else {
                    $absen = 0;
                }
