...
class M_mt_biodata_01 extends Model
{
     ...
     public function setMiddleName($aMiddleName)
     {
     ...
     public function setPassportNo($aPassportNo)
     {
     	$this->passportNo = $aPassportNo;
     }
     ...
     {
     	$this->approveLevel = $aApproveLevel;
     }
     public function getApproveLevel()
     {
     	return $this->approveLevel;
     }
     public function setInternalId($aInternalId)
     {
     ...
     public function setPositionLevel($aPositionLevel)
     {
     	$this->positionLevel = $aPositionLevel;
     }
     ...
     public function setResidenceStatus($aResidenceStatus)
     {
     	$this->residenceStatus = $aResidenceStatus;
     }
     ...
     public function ins()
     {
     	...
     	if($this->positionLevel =="" || $this->positionLevel == NULL) 
     	{
          	$this->positionLevel = 0; 
     	}
     	...
     	if($this->residenceStatus =="" || $this->residenceStatus == NULL) 
     	{
          	$this->residenceStatus = ''; 
     	}
     	...
     	$stQuery .=   "passport_no,"; 
     	$stQuery .=   "placement,"; 
     	$stQuery .=   "approve_level,"; 
     	$stQuery .=   "internal_id,"; 
     	$stQuery .=   "position_level,"; 
     	$stQuery .=   "join_date,"; 
     	$stQuery .=   "id_card_no,"; 
     	$stQuery .=   "id_card_address,"; 
     	$stQuery .=   "current_address,"; 
     	$stQuery .=   "residence_status,"; 
     	$stQuery .=   "religion,"; 
     	...
     	$stQuery .=   "'".$this->db->escapeString($this->firstName)."',";
     	$stQuery .=   "'".$this->db->escapeString($this->middleName)."',";
     	$stQuery .=   "'".$this->db->escapeString($this->lastName)."',";
     	...
     	$stQuery .=   "'".$this->db->escapeString($this->company)."',";
     	$stQuery .=   "'".$this->db->escapeString($this->dept)."',";
     	$stQuery .=   "'".$this->db->escapeString($this->empPosition)."',";
     	$stQuery .=   "'".$this->db->escapeString($this->passportNo)."',";
     	$stQuery .=   "'".$this->db->escapeString($this->placement)."',";
     	$stQuery .=   "'".$this->db->escapeString($this->approveLevel)."',";
     	$stQuery .=   "'".$this->db->escapeString($this->internalId)."',";
     	$stQuery .=   " ".$this->positionLevel.",";
     	...
     	$stQuery .=   "'".$this->db->escapeString($this->residenceStatus)."',";
     ...
     public function upd($id)
     {
     	...
     	$stQuery .=   "first_name ='".$this->db->escapeString($this->firstName)."', "; 
     	$stQuery .=   "middle_name ='".$this->db->escapeString($this->middleName)."', "; 
     	$stQuery .=   "last_name ='".$this->db->escapeString($this->lastName)."', "; 
     	...
     	$stQuery .=   "company ='".$this->db->escapeString($this->company)."', "; 
     	$stQuery .=   "dept ='".$this->db->escapeString($this->dept)."', "; 
     	$stQuery .=   "emp_position ='".$this->db->escapeString($this->empPosition)."', "; 
     	$stQuery .=   "passport_no ='".$this->db->escapeString($this->passportNo)."', "; 
     	$stQuery .=   "placement ='".$this->db->escapeString($this->placement)."', "; 
     	$stQuery .=   "approve_level ='".$this->db->escapeString($this->approveLevel)."', "; 
     	$stQuery .=   "internal_id ='".$this->db->escapeString($this->internalId)."', "; 
     	$stQuery .=   'position_level ='.$this->positionLevel.','; 
     	...
     	$stQuery .=   "residence_status ='".$this->db->escapeString($this->residenceStatus)."', "; 
     ...
     public function setObjectById($id)
     {
     	...
     	$this->firstName = $arrayRow['first_name']; 
     	$this->middleName = $arrayRow['middle_name']; 
     	$this->lastName = $arrayRow['last_name']; 
