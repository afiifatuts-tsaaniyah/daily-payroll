...
class App extends BaseConfig
{
	...
	|
	*/
	// public $baseURL = 'http://103.242.105.210/ci4-template/';
	// public $baseURL = 'http://192.168.10.10/hris_new/';
	// $config['base_url'] = 'https://'.$_SERVER['HTTP_HOST'].'/hris_new/'
	public $baseURL = 'http://192.168.10.30/belajar/promincon/payroll-martabe-2/';
	// public $baseURL = 'http://sis.sangati.co//payroll-martabe/';
	// public $baseURL = 'http://192.168.10.17/ci4-template/';
	// public $baseURL = 'http://'.$_SERVER['HTTP_HOST'].'/rp-hris/';	
