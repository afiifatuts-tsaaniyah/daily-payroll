...
class Mtb_report extends BaseController
{
    ...
    public function exportSummaryPayrollMartabeAgr($yearPeriod, $sm, $monthPeriod)
    {
        ...
        $spreadsheet->getActiveSheet()
                ...
                ->setCellValue('O6', 'THR')
                ->setCellValue('P6', 'DANA KONPENSASI')
        ...
        foreach ($MultiSM as $key => $value) {
            ...
            foreach ($data as $row) {
                ...
                $spreadsheet->getActiveSheet()
                    ...
                    ->setCellValue('I'.$rowIdx, $row['potongan_absensi'])
                    ...
                    ->setCellValue('V'.$rowIdx, $row['gaji'])
...
;
    ...
    $spreadsheet->getActiveSheet()->getStyle("A5:F5")->applyFromArray($center);
        ...
        $spreadsheet->getActiveSheet()
                ...
                ->setCellValue('B'.($rowIdx+4), 'Due Date:')
                ->setCellValue('C9', '')
                ->setCellValue('D9', '')
                ->setCellValue('E9', '')
                ;  
            $spreadsheet->getActiveSheet()
                ...
                $datenow = date("Y/m/d");
	     $spreadsheet->getActiveSheet()->getStyle('A'.($rowIdx+8).':F'.($rowIdx+8))->getFont()->setBold(true)->setSize(12);
