    ...
    public function Excel($ts_id,$checkBpjs,$checkJHT,$checkJP,$checkJKKJKM,$cbEnd,$spreadsheet, $noNewSheet)
    {
        ...
        if($sPayroll=="Daily"){
            ...
            $limit_data     = $this->db->query("SELECT COUNT(*) total FROM tr_timesheet a1, tr_slip b1 
                                ...
                                AND b1.year_period = '".$tDate3."' AND b1.month_period = '".$tDate1."'")->getRowArray()['total'] - 1;
            // echo "SELECT  b.payroll_group, b.input_time, b.month_period, b.year_period, b.ts_id,b.bs_prorate,
            //                     b.totalot AS total_ot,b.thr,b.allowance_01 AS siang, b.allowance_02 AS malam,b.allowance_03 AS lain2,b.adjustment,
            ...
            //                       AND b.year_period = '".$tDate3."' 
            //                       AND b.month_period = '".$tDate1."'
