...
class Mtb_invoice extends BaseController
{
    ...
    public function exportSummaryPayrollMartabeAgr($yearPeriod, $sm, $monthPeriod,  $dept)
    {
    ...
    public function exportPaymentPayrollMartabeAgr($yearPeriod, $monthPeriod, $sm, $dept)
    {   
    ...
    public function exportPaymentForm($yearPeriod, $monthPeriod, $sm)
    {
        ...
        $rowNo = 1;
         ...
         $spreadsheet->getActiveSheet()
	    ->setCellValue('C1', 'No. : ______________________________________________________')
	...
	$spreadsheet->getActiveSheet()->getStyle("A6:F6")->getFont()->setBold(true)->setSize(12);
    ...
    $spreadsheet->getActiveSheet()->getStyle("A5:F5")->applyFromArray($center);
        ...
        // $spreadsheet->getActiveSheet()->getStyle("B8:D8")->getFont()->setBold(true)->setSize(12);
            ...
            $spreadsheet->getActiveSheet()
                ...
                $datenow = date("Y/m/d");
	     $spreadsheet->getActiveSheet()->getStyle('A'.($rowIdx+9).':F'.($rowIdx+9))->getFont()->setBold(true)->setSize(12);
...
")
                ->setCellValue('B'.($rowIdx+19), "(  Julius Jiwanggono  )                                                      (                           )
")
