    ...
    <h1>PERHITUNGAN GAJI PER BULAN</h1>
      <table border='1'>
        <tr>
            ...
            <?php
            $tanggal = 0;
              $new_start_date     = $yearPeriod.'-'.$monthPeriod.'-'.$start;
              $new_end_date       = date('Y-m-d', strtotime('+1 month', strtotime($new_start_date))); 
              // $new_end_date       = date('Y-m-d', strtotime('+1 days', strtotime($new_end_date))); 
            ...
            <th style="background-color:rgb(0, 205, 117)"><center>ADJUSTMENT / Deducation <br><br> KETERANGAN</center></th>
            <th style="background-color:rgb(0, 205, 117)"><center>ADJUSTMENT / Deducation <br><br> JUMLAH</center></th>
        </tr>
              ...
              foreach ($dataId as $data) {
                ...
                if ($totalWd > 0) {
                  ...
                  foreach ($dataBySlipId as $row) {
                    ...
                    <td><?php echo $row['client_name']; ?></td>
                    <td class='number-cell'><center><?php echo number_format($row['daily'], 2, ',', '.')?></center></td>
                    <td><?php echo ''; ?></td>
                    <td><?php echo ''; ?></td>
                    <td class='number-cell'><center><?php echo number_format($row['thr'], 2, ',', '.')?></center></td>
                    <td><?php echo $row['bank_name']; ?></td>
                    <td><?= ($row['account_no']!='')? "'".$row['account_no'] : ''; ?></td>
                    <td><?php echo ''; ?></td>
                    <td><?php echo ''; ?></td>
                  </tr>
                  <?php 
