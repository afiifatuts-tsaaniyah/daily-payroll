                ...
                <div class="modal-header bg-primary">
                  ...
                  <form method="post" class="my_detail">
                      <div class="form-group">
                          ...
                          <select class="form-control" id="smDueDate" name="smDueDate" required="">
                            <option value="all" selected="">All</option>
                            <script type="text/javascript">
                              var tDate = 1;
                              for (var i = tDate; i <= 200; i++) 
      ...
      <script>
        $(document).ready(function(){
          ...
          $('#btnProcess').on("click", function(){
                ...
                var myUrl ='<?php echo base_url() ?>/Transaction/Tr_timesheet/proses/'+yearPeriod+'/'+monthPeriod+'/'+startDate+'/'+smprocess;
                $.post("<?php echo base_url() ?>/Transaction/Tr_timesheet/validasiCheck/"+yearPeriod+"/"+monthPeriod+"/"+startDate+'/'+smprocess, { data: yearPeriod }, function(response) {
                    if (response === "true") {
                        // Data valid
