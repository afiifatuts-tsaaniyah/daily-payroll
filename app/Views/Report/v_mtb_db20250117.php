<div class="col-md-12">
  <div class="tile bg-white">
    <h3 class="tile-title">Martabe DB</h3>
    ...
    <div class="tile-body">
     ...
     <div class="form-group col-sm-12 col-md-3">
          ...
          <select class="form-control" id="dataPrint" name="dataPrint" required="">
            ...
            <option value="dbsm">DB ( SM )</option>
          </select>
        </div>  
...
<script src="<?php echo base_url()?>/assets/js/main.js"></script>
    ...
    var slipTable = $('#invoiceList').DataTable({
        ...
        $('#printToFile').on("click", function(){
                ...
                if (name == "db") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_db/exportDbForm/'+yearPeriod+'/'+monthPeriod;
                }
                if (name == "dbsm") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_db/exportDbFormSM/'+yearPeriod+'/'+monthPeriod+'/'+sm;
                }
        ...
        $('#viewInvoiceList').on("click", function(){
                ...
                var myUrl ='';
                if (name == "db") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_db/getDbList/'+yearPeriod+'/'+monthPeriod;
                } if (name == "dbsm") {
                  var myUrl ='<?php echo base_url() ?>/Report/Mtb_db/getDbListSM/'+yearPeriod+'/'+monthPeriod+'/'+sm;
                }
