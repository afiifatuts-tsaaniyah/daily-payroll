...
<script>
  $(document).ready(function(){
    ...
    $('#printToFile').on("click", function(){
      ...
      var myUrl       ='<?php echo base_url() ?>/Report/Tax_calculation/exportTaxCalculation/'+yearPeriod;
    ...
    $('#viewTaxList').on("click", function(){
      var yearPeriod  = $('#yearPeriod').val();
      var myUrl ='<?php echo base_url() ?>/Report/Tax_calculation/getMtbArList/'+yearPeriod;
      spinner.style.display = 'flex';
      $.ajax({
        url : myUrl,
        method : "POST",
