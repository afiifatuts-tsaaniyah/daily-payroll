  ...
  <div class="tile bg-info">
    ...
    <div class="tile-body">
      ...
      <!-- <form class="row is_header" action="<?php #echo base_url() ?>transactions/sumbawa/Timesheet/payrollProcess"> -->
        ...
        <div class="form-group col-sm-12 col-md-5 multism">
          <label class="control-label">MULTI SM</label>
          <select class="form-control js-example-basic-multiple" id="multism" required="" name="states[]" multiple="multiple" style="height: calc(1.5em + 0.75rem + 4px);">
        ...
        <div class="form-group col-md-12 align-self-end">
  		    ...
  		    <br>
      	  <h3>
            <code id="dataProses" class="backTransparent">
              <span></span>
            </code>
          </h3>	
        </div>
...
<script>
  $(document).ready(function(){
    ...
    $('#printToFile').on("click", function(){
      ...
      if(name == "payment"){
        myUrl ='<?php echo base_url() ?>/Report/Mtb_report/exportPaymentPayrollMartabeAgr/'+yearPeriod+'/'+monthPeriod+'/'+multiSM;
      }else if (name == "summary"){
        myUrl ='<?php echo base_url() ?>/Report/Mtb_report/exportSummaryPayrollMartabeAgr/'+yearPeriod+'/'+multiSM+'/'+monthPeriod;
      }else if (name == "form"){
        myUrl ='<?php echo base_url() ?>/Report/Mtb_report/exportPaymentForm/'+yearPeriod+'/'+monthPeriod+'/'+multiSM;
      }
    ...
    $('#viewInvoiceList').on("click", function(){
      ...
      var myUrl ='';
      if (name  == "payment") {
        var myUrl ='<?php echo base_url() ?>/Report/Mtb_report/getPayrolldeptList/'+yearPeriod+'/'+monthPeriod+'/'+multiSM;
      } else if (name  == "invoice") {
        var myUrl ='<?php echo base_url() ?>/Report/Mtb_report/getPayrollList/'+yearPeriod+'/'+monthPeriod+'/'+multiSM;
      } else if (name  == "summary") {
