...
class M_tr_slip extends Model
{
     ...
     protected $adjustmentIn;
     protected $adjustmentOut;
     ...
     public function setAdjustmentIn($aAdjustmentIn)
     {
          $this->adjustmentIn = $aAdjustmentIn;
     }
     public function getAdjustmentIn()
     {
          return $this->adjustmentIn;
     }
     public function setAdjustmentOut($aAdjustmentOut)
     {
          $this->adjustmentOut = $aAdjustmentOut;
     }
     public function getAdjustmentOut()
     {
          return $this->adjustmentOut;
     }
     ...
     public function setThrByUser($aThrByUser)
     {
          $this->thrByUser = $aThrByUser;
     }
     public function getThrByUser()
     {
          return $this->thrByUser;
     }
     ...
     public function setcheckFinal($acheckFinal)
     {
          $this->checkFinal = $acheckFinal;
     }
     public function getcheckFinal()
     {
          return $this->checkFinal;
     }
     ...
     public function ins()
     {
          ...
          if ($this->adjustmentIn == "" || $this->adjustmentIn == NULL) {
               $this->adjustmentIn = 0;
          }
          if ($this->adjustmentOut == "" || $this->adjustmentOut == NULL) {
               $this->adjustmentOut = 0;
          }
          if ($this->thr == "" || $this->thr == NULL) {
               $this->thr = 0;
          }
          if ($this->thrByUser == "" || $this->thrByUser == NULL) {
               $this->thrByUser = 0;
          }
          ...
          if ($this->netto == "" || $this->netto == NULL) {
               $this->netto = 0;
          }
          if ($this->bonusNonReg == "" || $this->bonusNonReg == NULL) {
               $this->bonusNonReg = 0;
          }
          ...
          $stQuery .=   "adjustment,";
          $stQuery .=   "adjustment_in,";
          $stQuery .=   "adjustment_out,";
          $stQuery .=   "thr,";
          $stQuery .=   "thr_by_user,";
          $stQuery .=   "bpjs,";
          $stQuery .=   "jk,";
          ...
          $stQuery .=   "check_final"; //check_final 
          $stQuery .= ") ";
          $stQuery .= "VALUES ";
          $stQuery .= "( ";
          $stQuery .=   " " . $this->slipId . ",";
          ...
          $stQuery .=   "'" . $this->db->escapeString($this->stand_by_count) . "',";
          ...
          $stQuery .=   " " . $this->adjustmentIn . ",";
          $stQuery .=   " " . $this->adjustmentOut . ",";
          $stQuery .=   " " . $this->thr . ",";
          $stQuery .=   " " . $this->thrByUser . ",";
          $stQuery .=   " " . $this->bpjs . ",";
          $stQuery .=   " " . $this->jk . ",";
          $stQuery .=   " " . $this->jkk . ",";
          $stQuery .=   " " . $this->jkm . ",";
          ...
          $stQuery .=   "'" . $this->db->escapeString($this->bs_prorate) . "',";
          $stQuery .=   "'" . $this->db->escapeString($this->gajipokok) . "',";
          ...
          $stQuery .=   " '" . $this->checkFinal . "'";
          $stQuery .= "); ";
          // echo $stQuery.'<br/><br/><br/>';
          // exit(); 
     ...
     public function upd($slipId)
     {
          ...
          $stQuery .=   'adjustment_in =' . $this->adjustmentIn . ',';
          $stQuery .=   'adjustment_out =' . $this->adjustmentOut . ',';
          $stQuery .=   'thr =' . $this->thr . ',';
          $stQuery .=   'thr_by_user =' . $this->thrByUser . ',';
     ...
     public function getUpdQuery($id)
     {
          ...
          $stQuery .=   'work_total =' . $this->workTotal . ',';
          $stQuery .=   "stand_by_count ='" . $this->db->escapeString($this->stand_by_count) . "', ";
          ...
          $stQuery .=   "bs_prorate ='" . $this->db->escapeString($this->bs_prorate) . "', ";
     ...
     public function setObjectById($id)
     {
          ...
          $this->adjustmentIn = $arrayRow['adjustment_in'];
          $this->adjustmentOut = $arrayRow['adjustment_out'];
          $this->thr = $arrayRow['thr'];
          $this->thrByUser = $arrayRow['thr_by_user'];
     ...
     public function getDataTax($biodataId, $bulan, $tahun)
     {
          ...
          // Penambahan IF bertujuan untuk bulan 12 ada yg END dan perhitungan Pajak
          if ($bulan == 12) {
               $sql = " SELECT SUM(pph21) AS total_pph21, SUM(brutto) AS total_kotor, SUM(emp_jp) as total_jp, SUM(emp_jht) as total_jht
                    FROM tr_slip
                    WHERE biodata_id =  " . $biodataId . "
                    AND (year_period = " . $tahun . " AND month_period = $bulan) ";
          } else {
               $sql = "SELECT SUM(pph21) AS total_pph21, SUM(brutto) AS total_kotor, SUM(emp_jp) as total_jp, SUM(emp_jht) as total_jht
                    FROM tr_slip
                    WHERE biodata_id = " . $biodataId . "
     ...
     public function getDataBpjs($biodataId, $bulan, $tahun)
     {
