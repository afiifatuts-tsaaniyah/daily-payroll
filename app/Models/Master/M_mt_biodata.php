...
class M_mt_biodata extends Model
{
     ...
     public function setBpjsStatus($aBpjsStatus)
     {
          $this->BpjsStatus = $aBpjsStatus;
     }
     public function getBpjsStatus()
     {
     ...
     public function ins()
     {
          ...
          if($this->BpjsStatus =="" || $this->BpjsStatus == NULL) 
          {
               $this->BpjsStatus = 0; 
          }
     ...
     public function upd($id)
     {
          ...
          $stQuery .=   'bpjs_status ='.$this->BpjsStatus.','; 
     ...
     public function updSalary($id)
     {
          $stQuery  = "UPDATE mt_salary "; 
          $stQuery .= "SET "; 
          $stQuery .=   "status_payroll ='".$this->db->escapeString($this->empStatus)."'"; 
          $stQuery .= 'WHERE '; 
          $stQuery .=   "biodata_id = '".$this->db->escapeString($id)."' AND is_active = 1"; 
          // echo $stQuery;
          // exit();
          $this->db->query($stQuery); 
     }
	...
	$stQuery  = "SELECT * FROM ".$this->table." WHERE is_active='1' "; 
     ...
     {
     $stQuery  = "SELECT a.*, b.status_payroll FROM ".$this->table." a, mt_salary b WHERE a.biodata_id = b.biodata_id AND a.is_active='1' AND b.is_active='1' "; 
          $query  = $this->db->query($stQuery); 
          $arrayList = $query->getResultArray(); 
          return $arrayList;      
     }
     ...
     {
     $stQuery  = "SELECT * FROM ".$this->table." WHERE  id_card_no = '".$ktp."' "; 
     // echo $stQuery;
     // exit();
          $query  = $this->db->query($stQuery); 
